/**
 * SubmittedSupport Page
 *
 * This component displays the applicant's references and attachments for a submitted job application
 ...
 *
 * Usage:
 * - Used as a route page: `/submitted-application/support?applicationId=...`
 *
 * State:
